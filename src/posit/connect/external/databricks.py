...
class WorkbenchStrategy(CredentialsStrategy):
    ...
    `databricks_config()` helper method in this module.
    ...
    * https://docs.posit.co/ide/server-pro/user/posit-workbench/guide/databricks.html#databricks-with-python
    ...
    from posit.connect.external.databricks import WorkbenchStrategy
...
def databricks_config(
    ...
    * https://docs.posit.co/connect/admin/integrations/oauth-integrations/databricks/
    ...
    from databricks.sdk.core import ApiClient
    from databricks.sdk.core.credentials_provider import oauth_service_principal
    from databricks.sdk.service.iam import CurrentUserAPI
    from shiny import reactive
    from shiny.express import render, session
    ...
    from databricks.sdk.core import ApiClient
    from databricks.sdk.core.credentials_provider import azure_service_principal
    from databricks.sdk.service.iam import CurrentUserAPI
    from shiny import reactive
    from shiny.express import render
