...
class TestUserAttributes:
    def test_guid(self):
        ...
        user = User(session, guid="test_guid")
    ...
    def test_email(self):
        ...
        user = User(session, email="test@example.com")
    ...
    def test_username(self):
        ...
        user = User(session, username="test_user")
    ...
    def test_first_name(self):
        ...
        user = User(session, first_name="John")
    ...
    def test_last_name(self):
        ...
        user = User(session, last_name="Doe")
    ...
    def test_user_role(self):
        ...
        user = User(session, user_role="admin")
    ...
    def test_created_time(self):
        ...
        user = User(session, created_time="2022-01-01T00:00:00")
    ...
    def test_updated_time(self):
        ...
        user = User(session, updated_time="2022-01-01T00:00:00")
    ...
    def test_active_time(self):
        ...
        user = User(session, active_time="2022-01-01T00:00:00")
    ...
    def test_confirmed(self):
        ...
        user = User(session, confirmed=True)
    ...
    def test_locked(self):
        ...
        user = User(session, locked=False)
